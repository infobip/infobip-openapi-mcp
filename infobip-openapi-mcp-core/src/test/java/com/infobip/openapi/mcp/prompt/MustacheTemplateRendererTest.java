...
class MustacheTemplateRendererTest {
    ...
    void shouldCompileAndRenderTemplate() {
        // Given
        renderer.compileTemplates("greet", List.of(new PromptMessageDefinition("user", "Hello {{name}}, welcome!")));
    ...
    void shouldRenderMissingKeyAsEmptyString() {
        ...
        renderer.compileTemplates(
                "greet", List.of(new PromptMessageDefinition("user", "Hello {{name}}, your role is {{role}}.")));
    ...
    void shouldNotHtmlEscapeSpecialCharacters() {
        // Given
        renderer.compileTemplates("code", List.of(new PromptMessageDefinition("user", "Value: {{value}}")));
    ...
    void shouldRenderMultipleTemplatesForSamePrompt() {
        ...
        renderer.compileTemplates(
                "chat",
                List.of(
                        new PromptMessageDefinition("user", "Hello {{name}}"),
                        new PromptMessageDefinition("assistant", "Hi {{name}}, how can I help?"),
                        new PromptMessageDefinition("user", "Tell me about {{topic}}")));
    ...
    void shouldClearCompiledTemplates() {
        // Given
        renderer.compileTemplates("greet", List.of(new PromptMessageDefinition("user", "Hello {{name}}")));
    ...
    void shouldRenderTemplateWithNoPlaceholders() {
        // Given
        renderer.compileTemplates("static", List.of(new PromptMessageDefinition("user", "This is a static message.")));
