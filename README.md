...
| `infobip.openapi.mcp.tools.naming.strategy`                                        | The naming strategy to use for generating tool names. Default is ENDPOINT.                                                                                                                                                                                                                                                                              | `ENDPOINT`     | 
...
| `infobip.openapi.mcp.security.auth.oauth.scope-discovery.enabled`                  | Enable OAuth scope discovery. Default is false.                                                                                                                                                                                                                                                                                                         | `false`        |
