...
class StatelessHttpTransportAuthenticationFilterTest extends AuthenticationTestBase {
    ...
    void shouldHandleMultipleScenarios() {
        ...
        then(response1.getHeaders().getFirst(HttpHeaders.WWW_AUTHENTICATE)).isNotEmpty();
