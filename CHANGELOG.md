...
- Documentation showing how to configure the framework against the Xquik OpenAPI spec,
  including the API base URL and credential guidance.
...
- Bumped dependencies: Jackson 2.21.3, Spring AI 1.1.6, Spring Boot 3.5.14, and others.
...
- Bumped dependencies: Jackson 2.21.2, Spring AI 1.1.4, Spring Boot 3.5.13.

### Added

- New `CredentialProvider` extension point that controls how credentials are sourced for
...
- Live reload now refreshes the MCP server description (instructions) from the updated OpenAPI spec.
